  ...
  return (
    ...
    >
      <div className="mx-4 mt-2">
        ...
        <p className="dark:text-gray-400">Browse all of your flashcards</p>
      </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              to solve smaller instances of a problem until reaching a base
              case.
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-2 flex flex-row items-center gap-2">
              ...
              <span className="text-sm">Created on Apr 5, 2025</span>
            </div>
          </CardContent>
        </Card>
        <Card>
