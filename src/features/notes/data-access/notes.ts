...
export async function createNote(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured during note creation. Please try again.',
    };
  }
}
  ...
  try {
    ...
    if (!fetchedNote) {
      return {
        success: false,
        error:
          'Note not found with the provided id, please try again with a valid id.',
      };
    }
    ...
    return {
      success: false,
      error:
        'An unexpected error occured while fetching the note. Please try again.',
    };
  }
}
  ...
  try {
    ...
    if (!notes) {
      return {
        success: false,
        error:
          'No notes found with the provided user id, please try again with a valid id.',
      };
    }
    ...
    return {
      success: false,
      error:
        'An unexpected error occured while fetching the notes. Please try again.',
    };
  }
}
...
export async function retrievePublicCardsByNoteId(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured while fetching the cards. Please try again.',
    };
  }
}
...
export async function retrievePublicNotesByUserId(
  ...
  try {
    ...
    const notes = await db
      ...
      .from(notesTable)
      .where(
        and(eq(notesTable.authorId, validatedId), eq(notesTable.public, true)),
      );
...
export async function updateNote(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured while updating note. Please try again.',
    };
  }
}
