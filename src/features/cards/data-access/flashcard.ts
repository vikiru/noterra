...
export async function createCard(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured during flashcard creation. Please try again.',
    };
  }
}
...
export async function deleteCard(id: string): Promise<ResponseData<string>> {
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured during flashcard deletion. Please try again.',
    };
  }
}
...
export async function retrieveCardById(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured during flashcard retrieval. Please try again.',
    };
  }
}
...
export async function updateCard(
  ...
  try {
    ...
    console.error(`Error updating flashcard with id ${updatedCard.id}:`, error);
    return {
      success: false,
      error:
        'An unexpected error occured during flashcard update. Please try again.',
    };
  }
}
