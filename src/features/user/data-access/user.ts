...
export async function createUser(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured while creating user. Please try again.',
    };
  }
}
...
export async function retrieveTotalCreations(
  ...
  try {
    ...
    return {
      success: false,
      error:
        'An unexpected error occured while fetching the total creations. Please try again.',
    };
  }
}
...
export async function retrieveUserActivityOverview(
  ...
  try {
    ...
    console.error(`Error getting user activity overview with id ${id}:`, error);
    return {
      success: false,
      error:
        'An unexpected error occured while fetching the activity overview. Please try again.',
    };
  }
}
